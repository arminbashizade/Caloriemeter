				...
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						if(login)
						{
							...
							registerSignInLink.setText(getString(R.string.action_sign_in_link_underlined));
						...
						else
						{
							...
							registerSignInLink.setText(getString(R.string.action_sign_up_link_underlined));
							registerButton.setVisibility(View.GONE);
